      ...
      (radioButton, index) => {
        ...
        return (
          <RadioButton
            ...
            displayText={radioButton.props.displayText}
            displayTextColor={radioButton.props.displayTextColor}
            displayTextActiveColor={radioButton.props.displayTextActiveColor}
            prefixWithAlphabet={radioButton.props.prefixWithAlphabet}
            prefixWithNumbers={radioButton.props.prefixWithNumbers}
            prefixColor={radioButton.props.prefixColor}
            prefixActiveColor={radioButton.props.prefixActiveColor}
          >
...
RadioGroup.defaultProps = {
  ...
  color: defaultColor,
  highlightColor: null,
  prefixWithAlphabet: false,
  prefixWithNumbers: false,
